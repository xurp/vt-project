...
# Data Parameters
tf.flags.DEFINE_string("input_text_file", "./data/test.utf8", "Test text data source to evaluate.")
tf.flags.DEFINE_string("input_label_file", "", "Label file for test text data source.")

# Eval Parameters
tf.flags.DEFINE_integer("batch_size", 64, "Batch Size (default: 64)")
#4类*100个 *300轮  分字版
tf.flags.DEFINE_string("checkpoint_dir", "./runs/1508839492/checkpoints", "Checkpoint directory from training run")
#4类*100个 *300轮  分词版
#tf.flags.DEFINE_string("checkpoint_dir", "./runs/1508828522/checkpoints", "Checkpoint directory from training run")
tf.flags.DEFINE_boolean("eval_train", True, "Evaluate on all training data")

# Misc Parameters
tf.flags.DEFINE_boolean("allow_soft_placement", True, "Allow device soft device placement")
tf.flags.DEFINE_boolean("log_device_placement", False, "Log placement of ops on deviceword2vecs")
...
if FLAGS.eval_train:
    ...
    #x_raw, y_test = data_helpers.load_data_and_labels1(FLAGS.input_text_file, FLAGS.input_label_file, num_labels)
else:
